...
@export_flags("FORCE_DRIVEN_CHARACTER:1", "CAR:2", "SPEED_BOAT:4", "HELICOPTER:8", "SUBMARINE:16") var can_occupy: int = 0
...
@export_flags("FORCE_DRIVEN_CHARACTER:1", "CAR:2", "SPEED_BOAT:4", "HELICOPTER:8", "SUBMARINE:16") var can_tow: int = 0
